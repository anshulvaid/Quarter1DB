...
public:
    ...
    //  1) For y fields, there is n-byte-null-indicators in the beginning of
    //   each record.
    //     The value n can be calculated as: ceil(y / 8). (e.g., 5 fields =>
    //     ceil(5 / 8) = 1. 12 fields => ceil(12 / 8) = 2.)
    ...
    //     If k-th bit from the left is set to 0, k-th field contains non-null
    //     values.
    //     If there are more than 8 fields, then you need to find the
    //     corresponding byte first, then find a corresponding bit inside that
    //     byte.
    //  2) Actual data is a concatenation of values of the attributes.
    //  3) For Int and Real: use 4 bytes to store the value;
    //     For Varchar: use 4 bytes to store the length of characters, then
    ...
    RC printRecord(const vector<Attribute>& recordDescriptor,
                   const void *data);
    ...
    **************************************************************************/
    ...
    RC scan(FileHandle& fileHandle,
            ...
            const vector<string>& attributeNames, // a list of projected
                                                  // attributes
